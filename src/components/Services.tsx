...
const Services = () => {
  ...
  return (
    <section ref={sectionRef} id="services" className="py-16 md:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {services.map((service, index) => {
            ...
            return (
              <div
                ...
                className={`group relative bg-white border-2 ${service.borderColor} rounded-xl md:rounded-2xl p-6 md:p-8 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer ${hoveredIndex === index ? 'scale-105' : ''
                  }`}
              >
                <div
                ...
                <p className="text-xs md:text-sm font-medium text-slate-500 mb-3 md:mb-4">
                  {service.subtitle}
                </p>
        ...
        <div ref={ctaRef} className="mt-12 md:mt-16 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl md:rounded-3xl p-6 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-6 md:mt-8">
              {[
                ...
                <div
                  key={index}
                  className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg md:rounded-xl p-4 md:p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
                >
